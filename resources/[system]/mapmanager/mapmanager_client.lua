...
AddEventHandler('onClientResourceStart', function(res)
    local numResourceMetadata = GetNumResourceMetadata(res, 'map')

    if numResourceMetadata > 0 then
        for i = 0, numResourceMetadata-1 do
    ...
    Citizen.CreateThread(function()
        ...
        if maps[res] then
            TriggerEvent("spawnmanager:spawnPlayer", { 
                position = vector4(-1634.3699, 209.8161, 60.6414, 0),
